...
class VHT_VHPATIENTTopListView extends VHT_VHPATIENT{
	...
	function create_new_list_query($order_by, $where,$filter=array(),$params=array(), $show_deleted = 0,$join_type='', $return_array = false,$parentbean=null, $singleSelect = false)
	{
		...
		//$ret_array['select'] =  'SELECT  reg_patient.id id, reg_patient.last_name name, reg_patient.first_name excellecy, reg_patient.first_name newtestfield_c ';
		//$ret_array['from'] = ' FROM reg_patient ';
        //$ret_array['where'] = ' WHERE 1 = 1';
		//$ret_Array['order_by'] = ' ORDER BY reg_patient.last_name DESC ';
		//return $ret_array;
