...
<div id="VHT_VHPATIENT_detailview_tabs"
>
<div >
...
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='VHT_VHPATIENT'}{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='VHT_VHPATIENT'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
<td width='25%'  >
